...
=======
      ...
      >
        <ul class="flex items-center space-x-4 lg:space-x-8 my-auto">
          <li>
            <router-link :to="{ name: 'search' }" class="hover:text-gray-300 no-underline"
>>>>>>> 3826133 (05-10 kong)
              >여행지검색</router-link
            >
          </li>
...
<<<<<<< HEAD
            <router-link
              ...
              class="hover:text-gray-300 no-underline"
=======
            <router-link :to="{ name: 'plan' }" class="hover:text-gray-300 no-underline"
>>>>>>> 3826133 (05-10 kong)
              >여행계획</router-link
            >
          </li>
...
<<<<<<< HEAD
            <router-link
              ...
              class="hover:text-gray-300 no-underline"
=======
            <router-link :to="{ name: 'BoardView' }" class="hover:text-gray-300 no-underline"
>>>>>>> 3826133 (05-10 kong)
              >자유게시판</router-link
            >
          </li>
...
<<<<<<< HEAD
            <router-link
              ...
              class="hover:text-gray-300 no-underline"
=======
            <router-link :to="{ name: 'notice' }" class="hover:text-gray-300 no-underline"
>>>>>>> 3826133 (05-10 kong)
              >공지사항</router-link
            >
          </li>
...
<<<<<<< HEAD
              ...
              <span class="text-gray-900 mx-2"
                >[ {{ store.state.member.name }}]님</span
...
=======
              class="hover:text-gray-300 pr-6 no-underline flex items-center text-sm"
            >
              <span class="text-gray-900 mx-2">[ {{ store.state.member.name }}]님</span
              ><span class="text-gray-900">
